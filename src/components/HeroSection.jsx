...
const HeroSection = () => {
    ...
    return (
        <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImagee.png")] bg-cover bg-center h-screen'>
            ...
            <div className='flex items-center gap-4 text-gray-300'>
                ...
                <div className='flex flex-item gap-1'>

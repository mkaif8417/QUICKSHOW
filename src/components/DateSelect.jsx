...
<button onClick={onBookhandler} className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer  relative z-50 '>Book Now</button>
      </div>
    </div>
  )
}
